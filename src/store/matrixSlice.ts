...
const initialState: MatrixState = {
  ...
  rowHeaders: [
    { id: 'row-1', label: 'Row 1-1', rowGroup: 'Group A\nSubtitle A', data: { 'col-1': '___LOADING___', 'col-2': 'R1C2', 'col-3': 'R1C3' } },
    { id: 'row-2', label: 'Row 1-2', rowGroup: 'Group A\nSubtitle A', data: { 'col-1': 'R2C1', 'col-2': '___LOADING___', 'col-3': 'R2C3' } },
    { id: 'row-3', label: 'Row 1-3', rowGroup: 'Group A\nSubtitle A', data: { 'col-1': 'R3C1', 'col-2': 'R3C2', 'col-3': '___LOADING___' } },
    { id: 'row-4', label: 'Row 2-1', rowGroup: 'Group B\nLine 2\nLine 3', data: { 'col-1': 'R4C1', 'col-2': 'R4C2', 'col-3': 'R4C3' } },
    { id: 'row-5', label: 'Row 2-2', rowGroup: 'Group B\nLine 2\nLine 3', data: { 'col-1': 'R5C1', 'col-2': 'R5C2', 'col-3': 'R5C3' } },
